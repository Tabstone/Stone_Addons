...
| --- | --- | --- | --- | --- |
| TabS Cleaner | `tabs-cleaner/` | CleanMyMac-style HAOS storage dashboard with safe and deep cleanup workflows | [Stone_Addons](https://github.com/Tabstone/Stone_Addons/tree/main/tabs-cleaner) | Built from Home Assistant base image |
...
| TVBox Auxiliary | `tvbox-auxiliary/` | TVBox JSON formatter and automation helper with persistent Json data | [nuu987/tvbox-auxiliary](https://github.com/nuu987/tvbox-auxiliary) | [ghcr.io/nuu987/tvbox-auxiliary](https://github.com/nuu987/tvbox-auxiliary/pkgs/container/tvbox-auxiliary) |
...
- TabS Cleaner is built in this repository and published to GHCR by `.github/workflows/tabs-cleaner-image.yml` for the architectures declared in its `config.yaml`.
