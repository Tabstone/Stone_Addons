...
| Claude Code Hub | `claude-code-hub/` | Claude Code 与 Codex API 代理服务，使用外部 PostgreSQL 和 Redis | [ding113/claude-code-hub](https://github.com/ding113/claude-code-hub) | [ghcr.io/ding113/claude-code-hub](https://github.com/ding113/claude-code-hub/pkgs/container/claude-code-hub) |
...
| TVBox Auxiliary | `tvbox-auxiliary/` | TVBox JSON 格式化与自动聚合辅助服务，持久化 Json 数据目录 | [nuu987/tvbox-auxiliary](https://github.com/nuu987/tvbox-auxiliary) | [ghcr.io/nuu987/tvbox-auxiliary](https://github.com/nuu987/tvbox-auxiliary/pkgs/container/tvbox-auxiliary) |
